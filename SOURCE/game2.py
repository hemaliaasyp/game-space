...
class GameScene(Scene):
    def __init__(self):
        ...
        player_imgs = {
            "NORMAL": {
                "MOVRIGHT": load_png("kitty4.png", IMG_DIR, img_sc2),
                "IDLE": load_png("kitty5.png", IMG_DIR, img_sc2),
                "MOVLEFT": load_png("kitty5.png", IMG_DIR, img_sc2) 
            },
            "SHIELDED": {
                "MOVRIGHT": load_png("kitty8.png", IMG_DIR, img_sc2),
                "IDLE": load_png("kitty8.png", IMG_DIR, img_sc2),
                "MOVLEFT": load_png("kitty8.png", IMG_DIR, img_sc2)
            }    
        }
        ...
        # Stats texts
        self.text_stats = Text(self.stats_area.get_width() / 2, 40, "Stats", GAME_FONT, 25, 'white')
        self.tulang_meter = TulangMeter(tulang_meter_imgs, (28, 70), "100", "10")
        self.text_scorelabel = Text(self.stats_area.get_width() / 2, self.stats_area.get_height() / 3.5, "Score", GAME_FONT, 23, 'white')
        self.text_score = Text(self.stats_area.get_width() / 2, self.stats_area.get_height() / 2.8, f"{str(self.score).zfill(5)}", GAME_FONT, 23, 'white')
        self.shield_o_meter = TulangMeter(shield_meter_imgs, (16, WIN_SZ[1] / 2.6), "2", "0", False)
        self.text_coinslabel = Text(self.stats_area.get_width() / 2, self.stats_area.get_height() / 1.3, "Coins", GAME_FONT, 23, 'yellow')
        self.text_coins = Text(self.stats_area.get_width() / 2, self.stats_area.get_height() / 1.18, f"{str(self.coins).zfill(5)}", GAME_FONT, 23, 'yellow')
    ...
    def draw(self, window):
        ...
        window.blit(self.stats_area, (WIN_SZ[0] / 1.3, 30))
        self.stats_area.fill('#87CEEB')
